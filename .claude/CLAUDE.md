...
bin/gitbuilt                                      # Format, lint, test, build
...
- Always run `bin/gitbuilt` when you're done to ensure formatting, linting, testing, and building all execute successfully
