...
/**
 * Names of all pg-boss queues used in the application. Centralising them here
 ...
 */
export const QUEUES = {
  /** Scheduled job that deletes archived links older than seven days. Runs at 03:00 UTC daily. */
