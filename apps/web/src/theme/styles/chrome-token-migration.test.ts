...
const MIGRATED_FILES = [
  ...
  'src/components/settings/ThemeEditor/AutoSaveStatus.tsx',
  ...
  'src/components/settings/ThemeEditor/KnobRow.tsx',
  'src/components/settings/ThemeEditor/MockHeader.tsx',
  ...
  'src/components/settings/ThemeEditor/TokenTree.tsx',
