 ...
 * pill (Read) so both tab styles can be checked at once. The visible copy is
 * asemic Old Turkic (see mockGlyphs) so the aria-hidden mock reads as decoration.
 */
