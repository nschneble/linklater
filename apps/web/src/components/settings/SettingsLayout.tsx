      ...
      <div className="min-w-0 space-y-6">
        ...
        <header className="pb-2">
          <h1
            id={HEADING_ID}
            tabIndex={-1}
            className="text-[var(--text)] text-2xl font-semibold text-balance focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] rounded-lg"
          >
            Settings
          </h1>
        </header>
        ...
        <div className="md:hidden flex justify-center">
          <button
            ...
            className="group flex items-center gap-2 min-h-10 px-3 py-2 hover:bg-[var(--bg-surface)] text-[var(--text-muted)] hover:text-[var(--text)] text-sm font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] rounded-lg motion-safe:active:scale-[0.96] motion-safe:[transition:background-color_150ms,color_150ms,scale_150ms] cursor-pointer"
          >
            <i
              className="fa-solid fa-arrow-up text-[var(--text-subtle)] text-xs"
              aria-hidden="true"
            />
            Back to top
          </button>
