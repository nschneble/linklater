      ...
      <div className="space-y-1 animate-pulse">
        <div className="flex flex-row items-center">
          ...
          <div className="flex flex-col items-start min-w-0 ml-3 gap-1.5 w-full">
            <div className="w-3/4 h-3.5 bg-[var(--orbit-bg)] rounded" />
            <div className="w-24 h-3 bg-[var(--orbit-bg)] rounded" />
          </div>
        </div>
        <div className="h-8 mt-2 space-y-1">
          <div className="w-full h-3 bg-[var(--orbit-bg)] rounded" />
          <div className="w-2/3 h-3 bg-[var(--orbit-bg)] rounded" />
        </div>
      </div>
    </div>
  );
