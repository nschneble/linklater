      ...
      <div className="flex items-center gap-2 mt-3 sm:mt-4 mb-3" inert={inert}>
        <div className="relative flex-1 min-w-0">
          <input
            ...
            className={`w-full min-w-0 pl-3 pr-10 py-2 bg-[var(--base-input-bg)] border border-[var(--base-border)] text-[var(--base-text)] text-base sm:text-sm placeholder:text-[var(--base-alt-text)] ${FOCUS_RING_FLUSH} rounded-lg [&::-webkit-search-cancel-button]:appearance-none`}
            type="search"
            placeholder={
