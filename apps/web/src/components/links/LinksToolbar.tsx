    ...
    <>
      ...
      <div className="flex items-center gap-2 mt-3 sm:mt-4 mb-3">
        <input
          ...
          className="flex-1 min-w-0 px-3 py-2 bg-[var(--bg-input)] border border-[var(--border)] text-[var(--text)] text-sm placeholder:text-[var(--text-subtle)] focus:outline-none focus:ring focus:ring-[var(--focus-ring)] focus:border-[var(--accent)] rounded-lg"
          type="search"
          placeholder={
