...
> = {
  ...
  elevated: `pl-3.5 pr-4 py-2 bg-[var(--bg-elevated)] disabled:bg-[var(--bg-elevated)] hover:bg-[var(--bg-surface)] border-shadow hover:border-shadow text-[var(--text)] font-semibold ${DISABLED} transition active:scale-[0.96] disabled:active:scale-100`,
};
