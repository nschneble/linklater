...
const variantClassesByHost: Record<Surface, Record<Variant, string>> = {
  base: {
    default: `${SMALL_PADDING} hover:bg-[var(--mount-bg)] disabled:bg-inherit aria-disabled:bg-inherit ring-1 ring-[var(--base-border)] text-[var(--base-text)] ${FOCUS_RING_FLUSH} disabled:active:scale-100 aria-disabled:active:scale-100`,
    danger: `${SMALL_PADDING} hover:bg-[var(--alert-bg)] ring-1 ring-[var(--alert-border)] text-[var(--alert-text)] ${FOCUS_RING_FLUSH}`,
    'danger-filled': `${SMALL_PADDING} bg-[var(--alert-highlight)] hover:bg-[var(--alert-highlight-hover)] ring-1 ring-[var(--alert-highlight)] hover:ring-[var(--alert-highlight-hover)] text-[var(--alert-highlight-fg)] ${FOCUS_RING}`,
    ghost: `${SMALL_PADDING} ring-1 ring-[var(--base-border)] text-[var(--base-alt-text)] ${FOCUS_RING_FLUSH}`,
  ...
  mount: {
    default: `${SMALL_PADDING} hover:bg-[var(--orbit-bg)] disabled:bg-inherit aria-disabled:bg-inherit ring-1 ring-[var(--mount-border)] text-[var(--mount-text)] ${FOCUS_RING_FLUSH} disabled:active:scale-100 aria-disabled:active:scale-100`,
    danger: `${SMALL_PADDING} hover:bg-[var(--alert-bg)] ring-1 ring-[var(--alert-border)] text-[var(--alert-text)] ${FOCUS_RING_FLUSH}`,
    'danger-filled': `${SMALL_PADDING} bg-[var(--alert-highlight)] hover:bg-[var(--alert-highlight-hover)] ring-1 ring-[var(--alert-highlight)] hover:ring-[var(--alert-highlight-hover)] text-[var(--alert-highlight-fg)] ${FOCUS_RING}`,
    ghost: `${SMALL_PADDING} ring-1 ring-[var(--mount-border)] text-[var(--mount-alt-text)] ${FOCUS_RING_FLUSH}`,
  ...
  orbit: {
    ...
    default: `${SMALL_PADDING} disabled:bg-inherit aria-disabled:bg-inherit ring-1 ring-[var(--orbit-border)] text-[var(--orbit-text)] ${FOCUS_RING_FLUSH} disabled:active:scale-100 aria-disabled:active:scale-100`,
    danger: `${SMALL_PADDING} hover:bg-[var(--alert-bg)] ring-1 ring-[var(--alert-border)] text-[var(--alert-text)] ${FOCUS_RING_FLUSH}`,
    'danger-filled': `${SMALL_PADDING} bg-[var(--alert-highlight)] hover:bg-[var(--alert-highlight-hover)] ring-1 ring-[var(--alert-highlight)] hover:ring-[var(--alert-highlight-hover)] text-[var(--alert-highlight-fg)] ${FOCUS_RING}`,
    ghost: `${SMALL_PADDING} ring-1 ring-[var(--orbit-border)] text-[var(--orbit-alt-text)] ${FOCUS_RING_FLUSH}`,
