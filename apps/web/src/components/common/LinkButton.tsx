...
export default function LinkButton({
  ...
  return (
    <button
      ...
      className={`${SURFACE_CLASSES[surface]} text-xs underline underline-offset-3 disabled:cursor-not-allowed cursor-pointer active:scale-[0.96] ${FOCUS_RING} rounded transition duration-200 ${className}`}
      disabled={disabled}
      onClick={onClick}
      {...props}
    >
