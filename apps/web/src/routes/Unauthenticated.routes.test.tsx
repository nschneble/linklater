 ...
 * route exercises that class contract; AuthFormWrapper is route-independent.
 *
 * Separate from `Unauthenticated.test.tsx` because that suite needs the real
 * `AuthForm` to prove a half-typed form survives, and this one needs it
 * stubbed; `vi.mock` is module-scoped, so they cannot share a file.
 */
